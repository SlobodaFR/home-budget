...
export function toRecurringTransactionDto(recurringTransaction: RecurringTransaction): RecurringTransactionDto {
  return {
    ...
    endDate: recurringTransaction.endDate ? recurringTransaction.endDate.toISOString() : null,
